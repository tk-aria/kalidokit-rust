...
pub fn glyph(ch: char) -> Option<[u8; 7]> {
    Some(match ch {
        ...
        // Lowercase (map to uppercase-like glyphs for simplicity)
        'a' => [
...
pub const CHAR_W: f32 = 0.012;
/// Character cell height in NDC units.
pub const CHAR_H: f32 = 0.022;
/// Pixel size within a character cell.
pub const PIXEL_SIZE: f32 = 0.002;
/// Spacing between characters (NDC).
pub const CHAR_SPACING: f32 = 0.014;
/// Line height (NDC).
pub const LINE_HEIGHT: f32 = 0.028;
